...
<script>
    ...
    layui.use(['layer', 'table'], function () {
        ...
        table.render({
            ...
            url: '${pageContext.request.contextPath}/returneesAccessApply/list', // 请求地址
            ...
            if (obj.event === 'pass') {   // 点击了通过按钮
                layer.confirm('真的通过吗', function (index) {
                    ...
                    $.ajax({
                        ...
                        url: "/returneesAccessApply/update",   // 请求地址
                            ...
                            layer.msg(
                                ...
                                function () {
                                    ...
                                    table.reload('test', {
                                        ...
                                        <%--url: '${pageContext.request.contextPath}/returneesAccessApply/list',--%>
                                        // ,methods:"post"
                                        where: {  //设定异步数据接口的额外参数
                                            // query: inputVal
                                        },
        ...
        $('#search_input').bind('keypress', function (event) {
            ...
            if (event.keyCode == '13') {
                ...
                table.reload('test', {
                    // url可以不指定，会使用table.render中指定的
                    url: '${pageContext.request.contextPath}/returneesAccessApply/list'  // 因为设置了分页，所以会带上参数发请求 ?page=1&limit=5&query= （query是下面where中定义的参数名）
                    ,
                    // ,methods:"post"
                    where: {  // 设定异步数据接口的额外参数
                        query: inputVal
        ...
        table.on('toolbar(test)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case "refresh":  // 如果是点击了刷新按钮
                    ...
                    table.reload('test', {
                        // url可以不指定，会使用table.render中指定的
                        url: '${pageContext.request.contextPath}/returneesAccessApply/list',  // 因为设置了分页，所以会带上参数发请求 list-data2.json?page=1&limit=5&query= （query是下面where中定义的参数名）
                        // ,methods:"post"
                        where: {  //设定异步数据接口的额外参数
                            query: inputVal
                        },
