...
<script>
    ...
    layui.use(['layer', 'table'], function () {
        ...
        table.render({
            ...
            url: '${pageContext.request.contextPath}/news/list', // 请求地址
                            ...
                            layer.msg(
                                ...
                                function () {
                                    ...
                                    table.reload('test', {
                                        ...
                                        url: '${pageContext.request.contextPath}/news/list',  // 因为设置了分页，所以会带上参数发请求 list-data2.json?page=1&limit=5&query= （query是下面where中定义的参数名）
                                        // ,methods:"post"
                                        where: {  //设定异步数据接口的额外参数
                                            // query: inputVal
                                        },
        ...
        $('#search_input').bind('keypress', function (event) {
            ...
            if (event.keyCode == '13') {
                ...
                table.reload('test', {
                    // url可以不指定，会使用table.render中指定的
                    url: '${pageContext.request.contextPath}/news/list'  // 因为设置了分页，所以会带上参数发请求 ?page=1&limit=5&query= （query是下面where中定义的参数名）
                    ,
                    // ,methods:"post"
                    where: {  // 设定异步数据接口的额外参数
                        query: inputVal
