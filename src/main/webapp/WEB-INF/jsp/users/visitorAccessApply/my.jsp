...
<script>
    ...
    layui.use(['layer', 'table'], function () {
        ...
        table.render({
            ...
            url: '${pageContext.request.contextPath}/visitorAccessApply/my', // 请求地址
            ...
            if (obj.event === 'del') {   // 点击了删除按钮
                layer.confirm('真的删除吗', function (index) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: data.field,
                        url: "/visitorAccessApply/delete/" + data.applyId,
                            ...
                            layer.msg(
                                ...
                                function () {
                                    ...
                                    table.reload('test', {
                                        ...
                                        url: '${pageContext.request.contextPath}/visitorAccessApply/my',  // 因为设置了分页，所以会带上参数发请求 list-data2.json?page=1&limit=5&query= （query是下面where中定义的参数名）
                                        // ,methods:"post"
                                        where: {  //设定异步数据接口的额外参数
                                            // query: inputVal
                                        },
            ...
            switch (obj.event) {
                case 'add':  // 如果是点击了增加按钮
                    layer.open({
                        ...
                        content: ["/users/visitorAccessApply/add"],
                ...
                success: function (data) {  // 成功回调函数
                    layer.msg(
                        ...
                        function () {
                            ...
                            table.reload('test', {
                                // url可以不指定，会使用table.render中指定的
                                <%--url: '${pageContext.request.contextPath}/visitorAccessApply/my',--%>
                                // ,methods:"post"
                                where: {  //设定异步数据接口的额外参数
                                    // query: inputVal
                                },
