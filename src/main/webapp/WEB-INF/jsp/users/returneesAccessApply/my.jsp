...
<script>
    ...
    layui.use(['layer', 'table'], function () {
        ...
        table.render({
            ...
            url: '${pageContext.request.contextPath}/returneesAccessApply/my', // 请求地址
            ...
            if (obj.event === 'del') {   // 点击了删除按钮
                layer.confirm('真的删除吗', function (index) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: data.field,
                        url: "/returneesAccessApply/delete/" + data.applyId,
                            ...
                            layer.msg(
                                ...
                                function () {
                                    ...
                                    table.reload('test', {
                                        ...
                                        url: '${pageContext.request.contextPath}/returneesAccessApply/my',  // 因为设置了分页，所以会带上参数发请求 list-data2.json?page=1&limit=5&query= （query是下面where中定义的参数名）
                                        // ,methods:"post"
                                        where: {  //设定异步数据接口的额外参数
                                            // query: inputVal
                                        },
            ...
            switch (obj.event) {
                case 'add':  // 如果是点击了增加按钮
                    layer.open({
                        ...
                        content: ["/users/returneesAccessApply/add"],
